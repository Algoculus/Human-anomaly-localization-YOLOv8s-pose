...
class YOLOPoseDetector:
    # Wrapper for YOLOv8 pose detection with optional low-light preprocessing
    ...
    def __init__(self, model_path="yolov8s-pose.pt", imgsz=640, conf_thres=0.25, 
        ...
        # Initialize YOLO pose detector with given parameters
    ...
    def _preprocess(self, image):
        # Apply low-light preprocessing if enabled (DRY principle - delegates to preprocessing module)
    ...
    def detect(self, image):
        # Run pose detection on an image, returns list of dicts with bbox, conf, keypoints, bbox_area
